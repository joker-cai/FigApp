function BitExport(app,filename,mydpi,mymat)
...
if ~isnan(iNumberVector)
    ...
    for i=1:L
        ...
        set(handleMyFigure,'PaperPositionMode','auto','-bestfit');%'-bestfit''-fillpage'
        print(handleMyFigure,nameappend,mymat,mydpi);
